...
//apple has a very strict serialization of date objects
//which is funny because its an ISO standard, not an IOS standard
Date.prototype.toIOSString = function() {
...
var toPlist = function(doc, object, parent) {
  ...
  case 'object':
    if(object instanceof Buffer) {
      ...
      element = libxml.Element(doc, 'date').text(object.toIOSString());
